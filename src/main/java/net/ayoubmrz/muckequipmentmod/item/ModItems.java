...
//  ----------------------------------------------------------------------------------------------------
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, Identifier.of(MuckEquipmentMod.MOD_ID, name), item);
    }

    public static void registerModItems() {
        MuckEquipmentMod.LOGGER.info("Registering Mod Items for " + MuckEquipmentMod.MOD_ID);
