package net.ayoubmrz.muckequipmentmod.util;
...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> MINEABLE_WITH_MITHRIL_PICKAXE =
                TagKey.of(RegistryKeys.BLOCK, Identifier.of(MuckEquipmentMod.MOD_ID, "mineable_with_mithril_pickaxe"));

        public static final TagKey<Block> MINEABLE_WITH_ADAMANTITE_PICKAXE =
                TagKey.of(RegistryKeys.BLOCK, Identifier.of(MuckEquipmentMod.MOD_ID, "mineable_with_adamantite_pickaxe"));


        private static TagKey<Block> createTag(String name) {
            return TagKey.of(RegistryKeys.BLOCK, Identifier.of(MuckEquipmentMod.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        public static final TagKey<Item> MITHRIL_PICKAXES =
                TagKey.of(RegistryKeys.ITEM, Identifier.of(MuckEquipmentMod.MOD_ID, "mithril_pickaxes"));

        public static final TagKey<Item> ADAMANTITE_PICKAXES =
                TagKey.of(RegistryKeys.ITEM, Identifier.of(MuckEquipmentMod.MOD_ID, "adamantite_pickaxes"));


        private static TagKey<Item> createTag(String name) {
            return TagKey.of(RegistryKeys.ITEM, Identifier.of(MuckEquipmentMod.MOD_ID, name));
        }
    }
}
